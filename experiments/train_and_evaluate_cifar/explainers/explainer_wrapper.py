# code based on https://github.com/visinf/idsds/blob/main/explainers/explainer_wrapper.py
...
class TorchcamExplainer(AbstractAttributionExplainer):
    ...
    def __init__(self, explainer, model):
        ...
        self.model = model
        #self.explainer_name = type(self.explainer).__name__
        self.resizer = transforms.Resize((32,32), interpolation=Image.BILINEAR)
        #self.baseline = baseline
        #self.nt_type = nt_type
        #self.nt_samples = 10
